...
export const URL = {
  ...
  SALES_CHANNEL_LIST: MJR_CATALOG + '/sales-channel-list',
  ADD_UPDATE_SALES_CHANNEL: MJR_CATALOG + '/add-update-sales-channel',
  SALES_CHANNELBYID: MJR_CATALOG + '/sales-channelbyid',
